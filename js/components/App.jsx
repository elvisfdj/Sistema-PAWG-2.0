                        ...
                        <div className="p-6 overflow-y-auto text-sm text-gray-700 space-y-8">
                            ...
                            <section id="manual-tax">
                                ...
                                <ul className="list-disc list-inside space-y-1 mb-2">
                                    ...
                                    <li><b>🕵️ Consultar CNPJs:</b> consulta na Receita (via open.cnpja.com) todos os CNPJs do mês ainda não verificados, um de cada vez (limite de 5 consultas/minuto — por isso o delay de ~12s entre cada). <b>Ignora quem foi classificado manualmente</b> (Porte/Tributação/VISA digitados à mão antes de qualquer consulta) — pra reconsultar um desses de propósito, use o botão 🔍/🔄 individual da própria linha.</li>
                                    ...
                                    <li><b>Exportar CSV:</b> exporta a lista atual em planilha.</li>
                                    <li><b>📑 Relatório PDF:</b> gera um ZIP com 1 PDF por auditor + resumo geral. Abre um modal perguntando <b>"Somente novos"</b> (só quem ainda não saiu em nenhum relatório anterior — ideal pra gerar a cada quinzena sem repetir quem já foi relatado) ou <b>"Todos"</b> (todo mundo da competência, como antes). Depois de gerar, quem entrou fica marcado como "já relatado" — isso não mexe em Auditor nem em N° OS, é um controle separado.</li>
                                    <li><b>🏷️ Resetar Relatório:</b> escape hatch — se precisar, faz todo mundo voltar a aparecer no próximo relatório "Somente novos" (sem afetar Auditor/OS).</li>
